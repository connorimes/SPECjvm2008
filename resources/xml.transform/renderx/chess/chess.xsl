...
<xsl:output method="xml"
    ...
    <fo:root>
      <fo:layout-master-set>
        ...
        <fo:simple-page-master master-name="pagemaster-first">
          ...
          <fo:region-before extent="1in" display-align="before" padding="0.7in"/>
      ...
      <fo:page-sequence master-reference="pagemaster-first" force-page-count="no-force">
            ...
            <fo:list-item>
              <fo:list-item-label end-indent="label-end()" text-align="start">
                <fo:block font-weight="bold" font-style="italic">
                  <xsl:text>Rendered to PDF with </xsl:text>
                  <fo:basic-link external-destination="url('http://www.renderx.com/tools/xep.html')"
                                color="#0000C0">
      ...
      <fo:page-sequence master-reference="pagemaster-others" initial-page-number="1">
  ...
  <xsl:template name="draw-list-item">
    ...
    <fo:list-item>
      <fo:list-item-label end-indent="label-end()" text-align="end">
        <fo:block font-weight="bold"><xsl:value-of select="$left"/></fo:block>
      </fo:list-item-label>
      <fo:list-item-body start-indent="body-start()" text-align="start">
        <fo:block><xsl:value-of select="$right"/></fo:block>
      </fo:list-item-body>
    </fo:list-item>
  </xsl:template>
  ...
  <xsl:template match="move">
    ...
    <xsl:param name="chessboard"
      select="'RNBQKBNRPPPPPPPPxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxpppppppprnbqkbnr'"/>
